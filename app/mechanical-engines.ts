...
export function createWorkshop(ctx:BuildContext){
 ...
 function mesh(geo:T.BufferGeometry,m:T.Material,parent:T.Object3D,name:string){const o=new T.Mesh(geo,m);o.castShadow=true;o.receiveShadow=true;o.userData.pieceName=name;parent.add(o);return o;}
